...
extends Instruction {
    ...
    public MOVI(VSPMachine m, String destination, String source) {
        super(m);
    ...
    public void run() throws Exception {
        byte v = (byte)Integer.parseInt(this.m_source);
    ...
    public String getString() {
        return String.format("movi \u001b[95;1m %s \u001b[0m, \u001b[93;1m %s \u001b[0m", this.m_destination, this.m_source);
    }
}
