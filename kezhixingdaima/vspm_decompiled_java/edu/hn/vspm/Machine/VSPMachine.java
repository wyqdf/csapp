 ...
 */
package edu.hn.vspm.Machine;

import edu.hn.vspm.Memory.Memory;
import edu.hn.vspm.Register.RegFile;
...
public class VSPMachine {
    ...
    public int Load(String strFilename) throws Exception {
        ...
        while ((strTmp = buffReader.readLine()) != null) {
            if ((strTmp = strTmp.trim()).startsWith("#") || strTmp.length() == 0) continue;
